...
- (void)configureInitialDisplayAttributes {
    CGColorRef blackgroundColor = CGColorRetain([PGApp.app colour:kPG_Colour_HUD_Background].CGColor);
    
    self.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.75];
    self.layer.shadowColor  = blackgroundColor;
    self.layer.shadowOpacity = 0.5;
    self.layer.shadowRadius = 15.0f;
    self.layer.cornerRadius = 10.0f;

    CGColorRelease(blackgroundColor);
...
#pragma clang diagnostic pop
        ...
        _statusLabel.textColor = [PGApp.app colour:kPG_Colour_HUD_Message];
...
#pragma clang diagnostic pop
        ...
        _titleLabel.textColor = [PGApp.app colour:kPG_Colour_HUD_Title];
...
- (UIActivityIndicatorView *)activityIndicator {
    if (_activityIndicator == nil) {
        ...
        _activityIndicator.color = [PGApp.app colour:kPG_Colour_HUD];
    }
