...
- (id)initWithPlaceHolder:(NSString*)placeHolder maxCount:(NSUInteger)maxCount buttonStyle:(YIPopupTextViewButtonStyle)buttonStyle tintsDoneButton:(BOOL)tintsDoneButton
{
    ...
    if (self) {
        _shouldAnimate = YES;
        _maxCount = maxCount;
#warning //FIXME: PGApp.app.width should be replaced
        _backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, PGApp.app.width, 460)];
        _backgroundView.backgroundColor = [UIColor blackColor];
        _backgroundView.alpha = 0;
        _backgroundView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
#warning //FIXME: PGApp.app.width should be replaced        
        _popupView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, PGApp.app.width, 240)];
        ...
        CGFloat buttonRisingRatio = 0.15;
        ...
        if (buttonStyle == YIPopupTextViewButtonStyleRightCancel ||
            ...
            switch (buttonStyle) {
                case YIPopupTextViewButtonStyleRightCancel:
                    buttonX = _popupView.bounds.size.width-TEXTVIEW_INSETS.right-(0.75-buttonRisingRatio)*CLOSE_IMAGE_WIDTH;
                ...
                case YIPopupTextViewButtonStyleRightCancelAndDone:
                    buttonX = _popupView.bounds.size.width-TEXTVIEW_INSETS.right-(2.15-buttonRisingRatio)*CLOSE_IMAGE_WIDTH;
                    autoresizing = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleBottomMargin;
                    break;
                default:
            ...
            _closeButton.frame = CGRectMake(buttonX, TEXTVIEW_INSETS.top-4*buttonRisingRatio*CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH);
        ...
        if (buttonStyle == YIPopupTextViewButtonStyleRightDone ||
            ...
            _acceptButton.frame = CGRectMake(buttonX, TEXTVIEW_INSETS.top-4*buttonRisingRatio*CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH);
