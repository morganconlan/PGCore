...
- (void)keyboardDidShow:(NSNotification *)inNotification {
    ...
    CGSize keyboardSize = [[inNotification userInfo][UIKeyboardFrameBeginUserInfoKey] CGRectValue].size;
...
- (BOOL)allCellsAreValid {
    ...
    for (NSArray *section in self.formCells) {
        for (BPFormCell *cell in section) {
            ...
            // InfoCells can't be validated
            if ([cell isKindOfClass:[BPFormInfoCell class]]) continue;
